...
End-to-end active learning loop for MACE models with DFT labeling and GA candidate selection.
- Iteratively generates bootstrapped training sets
- Trains MACE ensembles and computes mean TEST MAE
- Creates initial random populations and runs GA to propose new candidates
- Submits DFT relaxations and ensures sufficient relaxed structures
- Merges new DFT-labeled data into the dataset
- Tracks first and second stage TEST MAE across iterations
- Saves a plot of TEST MAE vs iteration index as test_mae_plot.png
