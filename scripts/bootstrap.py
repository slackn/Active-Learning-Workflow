#!/usr/bin/env python3
"""
generate_bootstraps.py

Prepare stratified validation and bootstrap training sets from a dataset.
- Reads dataset_iterXXX.xyz for a given iteration
- Extracts charges from XYZ comment lines
- Splits dataset into validation and training pools per charge
- Creates n_boot bootstrap training sets by sampling from the training pool
- Writes valid.xyz, train_pool.xyz, and bootstrap XYZs to iteration folder
- Generates manifest.json summarizing the split and bootstraps

Usage:
    python generate_bootstraps.py --config config.yaml --iter 0
"""
