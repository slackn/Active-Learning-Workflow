...
Run DFT relaxations with Turbomole using ASE. 
- Reads candidate structures from data/iterXXX/selected_for_dft.extxyz
- Optimizes each structure with BFGS until convergence
- Saves successful relaxations in dft_relaxed.extxyz
- Saves failed relaxations in dft_failed.extxyz
"""
