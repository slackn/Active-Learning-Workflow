...
Compute mean TEST MAE (Mean Absolute Error) from MACE log files for a given iteration.
- Scans all boot/run logs in runs/iterXXX/boot_*/logs/
- Extracts first and second TEST MAE values from each log
- Computes and prints the mean across all runs

Usage:
    python compute_test_mae.py --iter 0
"""
